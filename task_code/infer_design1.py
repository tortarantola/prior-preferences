...
instr_infer_practice_txt = visual.TextStim(win=win, ori=0, name='instr_infer_practice_txt',
    text=u'First, you\'ll do some practice trials. These are just for you to get used to the task; your responses won\'t count. Unlike in the real trials, the choices you will be learning here were generated randomly by a computer.\n\n[press space bar to begin]',    font=u'Arial',
    pos=[0, 0], height=0.06, wrapWidth=1.5,
    color=u'white', colorSpace=u'rgb', opacity=1,
    depth=0.0)
...
instr_infer_txt = visual.TextStim(win=win, ori=0, name='instr_infer_txt',
    text=u'Great! Now that you\'ve done some practice trials, we\'re ready to start the real trials. If you have any questions, please get the experimenter now. Otherwise, you can begin whenever you\'re ready. \n\nUnlike in the practice trials, the choices you will be learning here were made by an actual person.\n\n[press space bar to begin]',    font=u'Arial',
    pos=[0, 0], height=0.06, wrapWidth=1.5,
    color=u'white', colorSpace=u'rgb', opacity=1,
    depth=0.0)
...
if len(prefs)==41 and len(bids)==41: # If S completed the entire binary choice and BDM routines, run the auction
    ...
    class score:
        ...
        pymt_expl_tot = u'Your total payment is: \xa3' + '{0:.2f}'.format(final_pymt) + '\n\nThank you for participating! Please call the experimenter into the room.'
    ...
    auc_manual_txt = visual.TextStim(win=win, ori=0, name='auc_manual_txt',
        text=u'Thank you! This completes the experiment. Please get the experimenter, who will run the auction and calculate your final payment.\n\nCorrect: ' + str(correct_counter) + '\nIncorrect: ' + str(incorrect_counter),    font=u'Arial',
