...
// DRIFT DIFFUSION MODEL: BAYESIAN w/BIASED DRIFT (UNBIASED PRIOR)
...
data {
    ...
    real rt_mins[NS]; // list of each subject's lowest response time (except for subjects C12, C26, and C31, which had implausibly low RTs, and for whom we've substituted the lowest RT from all other subjects)
}
